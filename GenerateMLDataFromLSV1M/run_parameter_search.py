...
if experiment == "DanButts":
          ...
          for f,l,t in zip(files,length,trials):
              ...
              CombinationParameterSearch(SlurmSequentialBackend(num_threads=1, num_mpi=16,slurm_options=['--hint=nomultithread','-x w[1-12,15,16]','-N 1-1',envexport],path_to_mozaik_env='/home/antolikjan/virt_env/mozaiknew/bin/activate'), {
                'trial' : [i],
          ...
          CombinationParameterSearch(SlurmSequentialBackend(num_threads=1, num_mpi=16,slurm_options=['--hint=nomultithread','-x w[1-12,15,16]','-N 1-1'],path_to_mozaik_env='/home/antolikjan/virt_env/mozaiknew/bin/activate'), {
            'trial' : [1],
